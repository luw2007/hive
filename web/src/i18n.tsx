...
const enMessages = {
  ...
  'marketplace.importButton': 'Import as template',
  'marketplace.imported': 'Imported {name} into the form',
  ...
  'marketplace.showAllCategories': 'Show all categories (+{count})',
  'marketplace.showCoreOnly': 'Show core only',
  'marketplace.sourceLabel': 'Source: {repo}',
  'marketplace.title': 'Template marketplace',
  'marketplace.viewSource': 'View source',
...
const zhMessages: Record<TranslationKey, string> = {
  ...
  'marketplace.importButton': '导入为模板',
  ...
  'marketplace.showAllCategories': '显示全部分类（+{count}）',
  'marketplace.showCoreOnly': '只看常用分类',
  'marketplace.sourceLabel': '来源：{repo}',
